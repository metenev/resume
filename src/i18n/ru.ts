        ...
        content: [
            {
                ...
                notes: [
                    ...
                    [
                        ...
                        'Backed и Frontend library чата для общения операторов и другого персонала: 2 разных адаптера для бэкэнда (PostgreSQL + Prisma и Firebase), websockets, библиотека с интерфейсом чата для встраивания в другие продукты',
